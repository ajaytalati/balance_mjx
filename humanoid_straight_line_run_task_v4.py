...
class HumanoidBalance(PipelineEnv):
    ...
    # def _update_ewa(ewa_state, new_value, alpha=0.1):
    #     """JAX-compatible EWA update with no side-effects."""
    #     return alpha * new_value + (1 - alpha) * ewa_state
    ...
    def step(self, state: State, action: jp.ndarray) -> HumanoidState:
        ...
        # TODO ankle_symmetry = (state.ewa_joint_positions["left_knee"] - state.ewa_joint_positions["right_knee"]) ** 2
    ...
    def reset(self, rng: jp.ndarray) -> HumanoidState:
        ...
        initial_ewa = {joint: 0.0 for joint in ["left_knee", "right_knee", "left_hip", "right_hip"]}
