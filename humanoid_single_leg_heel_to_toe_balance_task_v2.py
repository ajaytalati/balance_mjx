...
class HumanoidBalance(PipelineEnv):
    ...
    def step(self, state: State, action: jp.ndarray) -> State:
        ...
        standing_foot_quat = data.xquat[self._standing_foot_index]  # Standing foot quaternion
        non_standing_foot_quat = data.xquat[self._non_standing_foot_index]  # Non-standing foot quaternion
        ...
        standing_foot_forward = forward_vector_from_quaternion(standing_foot_quat)
        non_standing_foot_forward = forward_vector_from_quaternion(non_standing_foot_quat)
    
        # Compute alignment (dot product measures similarity)
        standing_alignment = jp.dot(torso_forward, standing_foot_forward)
        non_standing_alignment = jp.dot(torso_forward, non_standing_foot_forward)
    
        # Define penalty for feet not pointing forward
        foot_orientation_penalty = (
            (1.0 - standing_alignment) ** 2
            + (1.0 - non_standing_alignment) ** 2
        )
        ...
        reward = (
            ...
            - 2 * foot_forward_penalty
            - 2 * foot_orientation_penalty  # NEW: Foot orientation penalty (weighted)
            + healthy_reward
        )
        ...
        state.metrics.update(
            ...
            foot_orientation_penalty=-foot_orientation_penalty,  # NEW
    ...
    def reset(self, rng: jp.ndarray) -> State:
        ...
        # ✅ New: **Foot Orientation Penalty** at Reset
        torso_quat = data.xquat[self._torso_index]  # Torso quaternion
        standing_foot_quat = data.xquat[self._standing_foot_index]  # Standing foot quaternion
        non_standing_foot_quat = data.xquat[self._non_standing_foot_index]  # Non-standing foot quaternion
        ...
        reward = (
            self._stability_reward_weight * stability_reward
            - self._non_standing_foot_penalty_weight * foot_penalty
            - self._non_standing_foot_penalty_weight * foot_forward_penalty
            - 2.0 * foot_orientation_penalty  # NEW: Foot orientation penalty (weighted)
            + healthy_reward
        )
        ...
        metrics = {
            ...
            'control_penalty': -ctrl_cost,
            'foot_penalty': -foot_penalty,
            'foot_forward_penalty': -foot_forward_penalty,
            'foot_orientation_penalty': -foot_orientation_penalty,  # NEW
            'reward_alive': healthy_reward,
        }
