...
class HumanoidBalance(PipelineEnv):
    ...
    def step(self, state: State, action: jp.ndarray) -> HumanoidState:
        ...
        ROM_symmetry_penalty = knee_symmetry + hip_symmetry + sagittal_shoulder_symmetry + lateral_shoulder_symmetry + elbow_symmetry
        #TODO ankle_symmetry 
...
train_fn = functools.partial(
    ppo.train, 
    num_timesteps=400_000_000, # takes about a hour
    num_evals=5, 
